    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Life Cover Api",
                    Version = "v1"
                });
            });

            services.AddTransient<IPremiumCalculationService, PremiumCalculationService>();
            services.AddTransient<IValidator<LifePremiumModel>, LifePremiumModelValidator>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger Life Cover Api");
            });
        }
    }
}
